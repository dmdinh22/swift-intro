...
songTitles.append("Don't stop believin")
songTitles.append("Take on me")
songTitles.append("Careless Whisper")
 ...
 */
songTitles += ["Bodak Yellow", "I like it", "Bartier Cardi"]
...
for song in songTitles {
    print("woohoo, next singer up for \(song)!")
}
