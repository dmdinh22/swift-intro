...
func checkVotes(votes: [Bool]) {
    ...
    print("yes: \(yes), no: \(no)")
    yes > no ? print("This passed") : print("This failed")
}
...
checkVotes(votes: shouldMascotChangeVotes)

// reset count
yes = 0
no = 0

checkVotes(votes: shouldInstallCoffeeVendingMachineVotes)

yes = 0
no = 0

checkVotes(votes: shouldHaveMorePollOptionsVotes)
/*:
 ### Extension:
