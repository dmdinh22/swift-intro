...
let favoriteCar = makeFavorite(categoryOfThing: "car maker", favorite: "BMW")
let favoriteLiquor = makeFavorite(categoryOfThing: "liquor", favorite: "whisky")
...
print("Hello, my name is David. \(favoriteFood) \(favoriteCar) \(favoriteLiquor)")
