...
let impossibleBeliefs = impossibleBeliefsCount(pigsFlying: 50, frogsBecomingPrinces: 100, multipleLightningStrikes: 200)
let impossibleThings = impossibleThingsPhrase(numberOfImpossibleThings: impossibleBeliefs, meal: "dinner")
