...
let costOfRoomRental = 1000

let costOfPoster = 40

let totalTicketValue = numberOfTickets * 10

let totalExpenses = costOfRoomRental + costOfPoster

let totalShowIncome = totalTicketValue - totalExpenses
