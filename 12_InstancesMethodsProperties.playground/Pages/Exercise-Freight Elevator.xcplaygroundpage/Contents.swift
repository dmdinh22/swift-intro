...
var highCapacityPulley = TreehousePulley(weightCapacity: 2000)

ricketyRope.addLoadToBasket(loadWeight: light * 2)
highCapacityPulley.addLoadToBasket(loadWeight: light)
highCapacityPulley.addLoadToBasket(loadWeight: medium * 2)
highCapacityPulley.addLoadToBasket(loadWeight: heavy)
/*:
 - callout(Exercise):
