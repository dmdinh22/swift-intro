...
let customerOrdersCombined = "\(customerOrderFour), \(customerOrderFive), and \(customerOrderSix). Is that everything?"
/*:
 ...
 */
let serverResponseToTableTwo = "Let me make sure I've got this right: \(customerOrdersCombined)"
